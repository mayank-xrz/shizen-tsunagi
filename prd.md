...
| Route | Purpose |
|---|---|
| `/` | Manifesto, five catalog chapters (design.md §4), grower section, footer |
...
1. Every product chapter and detail page shows a **"Coming Soon — Notify Me"** button (no Add to Cart anywhere).
