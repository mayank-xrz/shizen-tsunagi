...
- **Recipient email is a hardcoded constant** (`stsales@shizentsunagi.com`). Env vars: `RESEND_API_KEY`, `UPSTASH_REDIS_REST_URL`, `UPSTASH_REDIS_REST_TOKEN`, `MODERATION_SECRET` — nothing else.
