...
| 1 — Static site | built — owner visual confirmation pending | 2026-07-15: all six pages live. Build ✓, lint ✓, / + 5 slugs 200 ✓, bad slug 404 ✓, every img alt non-empty ✓, no framework/new dep ✓, no color literal outside tokens (color-mix + `white` keyword logged) ✓. Done only when owner confirms 375px + 1280px rendering. |
