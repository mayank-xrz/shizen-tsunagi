...
// format shizen already uses, with one difference: `description` must be a
...
const HOMEPAGE = 'https://github.com/mayank-xrz/shizen-tsunagi';

const DESCRIPTIONS = {
  'shizen': 'Nature-coded minimalism for any coding task (write, refactor, fix, review): YAGNI, stdlib first, no unrequested abstractions. Not for non-coding requests.',
  'shizen-review': 'Review a diff for over-engineering. Finds what to delete: reinvented stdlib, needless deps, speculative abstractions. One line per finding.',
  'shizen-audit': 'Audit the whole repo for over-engineering. A ranked list of what to delete, simplify, or replace with stdlib or native features.',
  'shizen-debt': 'Harvest every shizen: shortcut comment into one debt ledger, so deferrals get tracked instead of forgotten. One-shot report.',
  'shizen-help': "Quick reference for shizen's modes, skills, and commands. One-shot display.",
};
