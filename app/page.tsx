      ...
      <section className="manifesto">
        <div className="wrap manifesto-grid">
          ...
          <div className="manifesto-text">
            ...
            {/* CTA (design.md §5) — owner-directed 2026-07-18, supersedes v5's
                no-CTA manifesto; href reads the first slug from data */}
            <a className="manifesto-cta" href={`#chapter-${products[0].slug}`}>
              Explore recipes
