...
Verbatim model output from the upstream [ponytail](https://github.com/DietrichGebert/ponytail) project's benchmark run (Claude Haiku 4.5, no-skill arm vs. the ladder this skill is built on, temperature 1) — carried over for illustration since this fork does not ship the benchmark harness.

## Without Shizen, 128 lines of code
