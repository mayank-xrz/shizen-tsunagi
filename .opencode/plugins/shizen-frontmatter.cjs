...
// shizen command-file frontmatter parser.
//
// Pulled out of shizen.mjs so the plugin module's only top-level export is
...
// leaves exactly one plugin-shaped export on shizen.mjs.
